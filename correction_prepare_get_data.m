...
function [fsn] = correction_prepare_get_data(fsn)
     ...
     disp('correction_prepare_get_data');
      ...
      if  fsn.param.correction_type == 0; % only instability correction: input 1 image
           ...
           load([fsn.data.folder 'img_full_distorted_complex_1.mat']); % data 1 name
           load([fsn.data.folder 'img_full_distorted_complex_2.mat']); % data 2 name
           img_1 = img_full_distorted_complex_1; % name of the data inside the .mat 1
           img_2 = img_full_distorted_complex_2; % name of the data inside the .mat 2
